//
//  KJTableViewTestNoHeaderNoMoreDataRefreshVC.m
//  KJTableView
//
...
@interface KJTableViewTestNoHeaderNoMoreDataRefreshVC ()

@property (weak, nonatomic) IBOutlet KJTableView *kjTableView;

@end

@implementation KJTableViewTestNoHeaderNoMoreDataRefreshVC
...
- (void)_configureKJTableView {
    ...
    self.kjTableView.listEngine.needPaging = NO;
